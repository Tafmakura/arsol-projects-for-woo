...
$customer_notice = \Arsol_Projects_For_Woo\Admin\Setup_Defaults\Setup_Defaults::get_effective_customer_notice($proposal->get_id(), 'proposal');
...
<?php
// 2. Post Content (proposal description)
if (!empty($proposal->get_title()) && !empty($post->post_content)) : ?>
