...
error_log("ARSOL DEBUG: Active project sidebar - ID: {$project->get_id()}, Title: '{$project->get_title()}', Type: {$project->get_post()->post_type}, Stage: '$current_stage'");
?>
...
/**
    ...
    <div class="arsol-pfw-sidebar-section arsol-pfw-sidebar-meta">
         ...
         */
        do_action('arsol_pfw_project_sidebar_meta', $current_stage, $project_id, $project);
        ?>
    </div>
