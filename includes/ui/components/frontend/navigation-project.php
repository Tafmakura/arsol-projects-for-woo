...
<div class="arsol-project-intro">
    <p>
        <?php 
            echo sprintf(
                esc_html__('Welcome to your %s project dashboard. The %s tab shows project details, %s tab displays your purchases, and %s tab manages your ongoing service plans.', 'arsol-pfw'),
