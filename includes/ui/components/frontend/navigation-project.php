...
<div class="arsol-project-intro">
    <p>
        <?php 
            echo sprintf(
                esc_html__('Welcome to your %s project dashboard. The %s tab shows project details, the %s tab displays your %s, and the %s tab displays all your active %s.', 'arsol-pfw'),
