...
<div class="project-overview-wrapper">
    <div class="project-content">
        <?php 
        // Check if there's a project overview override for requests
        if (\Arsol_Projects_For_Woo\Frontend_Template_Overrides::has_project_overview_override('request')) {
            echo \Arsol_Projects_For_Woo\Frontend_Template_Overrides::get_project_overview_override('request');
        } else {
