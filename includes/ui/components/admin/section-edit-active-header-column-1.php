...
<div class="form-field-row">
    <p class="form-field form-field-wide wc-customer-user">
        <label for="post_author_override">
            ...
            <?php if ($customer): ?>
                <a href="<?php echo admin_url('edit.php?post_status=all&post_type=arsol-pfw-active&author=' . $customer_id); ?>">
...
<div class="form-field-row">
    <p class="form-field form-field-wide">
        <label for="project_type"><?php _e('Project Type:', 'arsol-pfw'); ?></label>
        <select id="project_type" name="project_type" class="wc-enhanced-select">
            <option value="none" <?php selected($project_type, 'none'); ?>><?php _e('None', 'arsol-pfw'); ?></option>
            <option value="project" <?php selected($project_type, 'project'); ?>><?php _e('Project', 'arsol-pfw'); ?></option>
            <option value="service" <?php selected($project_type, 'service'); ?>><?php _e('Service', 'arsol-pfw'); ?></option>
        </select>
    </p>
</div>
