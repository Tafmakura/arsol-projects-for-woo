...
error_log("ARSOL DEBUG: Proposal sidebar - Using variables from parent: project_id=" . (isset($project_id) ? $project_id : 'not set') . ", current_status=" . (isset($current_status) ? "'$current_status'" : 'not set'));
