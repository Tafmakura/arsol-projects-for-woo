                ...
                <div class="project-sidebar">
                    ...
                    <div class="project-sidebar-wrapper">
                        <div class="project-sidebar-card card">
                            ...
                            $override = \Arsol_Projects_For_Woo\Frontend_Template_Overrides::get_shortcode_override('[arsol_pfw_project_sidebar]');
                            if ($override) {
                                echo do_shortcode($override . ' project_id="' . $project_id . '"');
                            } else {
                                echo do_shortcode('[arsol_pfw_project_sidebar project_id="' . $project_id . '"]');
                            }
                            ?>
