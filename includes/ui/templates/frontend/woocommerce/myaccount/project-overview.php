...
if ($display_mode === 'form') {
    $form_context = $is_edit_mode ? 'edit_project_form' : 'create_project_form';
}
$show_sidebar = \Arsol_Projects_For_Woo\Frontend_Template_Overrides::should_show_sidebar($project_id, $current_stage_id, $form_context);
