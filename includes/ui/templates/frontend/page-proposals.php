 ...
 * 
 * This template acts as the main container for the project proposals listing.
...
// Note: The new component will use $query, so we pass it along.

\Arsol_Projects_For_Woo\Frontend_Template_Overrides::render_template(
    'project_proposal_listings',
    ARSOL_PROJECTS_PLUGIN_DIR . 'includes/ui/components/frontend/section-project-proposal-listings.php',
