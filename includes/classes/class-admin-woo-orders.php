...
class AdminOrders {
    ...
    public function display_project_details($order) {
        ...
        <table class="shop_table shop_table_responsive my_account_orders woocommerce-orders-table woocommerce-MyAccount-subscriptions woocommerce-orders-table--subscriptions projects">
            <thead>
                <tr>
