        ...
        <div class="wrap">
            ...
            switch ($active_tab) {
                case 'display':
                    ...
                    break;
                case 'files':
                    include ARSOL_PFW_PLUGIN_DIR . 'ui/templates/admin/page-admin-settings-files.php';
                    break;
                case 'templates':
                    include ARSOL_PFW_PLUGIN_DIR . 'ui/templates/admin/page-admin-settings-templates.php';
                    break;
                case 'tools':
                    include ARSOL_PFW_PLUGIN_DIR . 'ui/templates/admin/page-admin-settings-tools.php';
                    break;
                case 'integrations':
                    include ARSOL_PFW_PLUGIN_DIR . 'ui/templates/admin/page-admin-settings-integrations.php';
                    break;
                default:
                    include ARSOL_PFW_PLUGIN_DIR . 'ui/templates/admin/page-admin-settings-general.php';
                    break;
            }
            ?>
        </div>
