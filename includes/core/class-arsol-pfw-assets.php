<?php
/**
 * Assets Class for Arsol Projects for WooCommerce
 *
 * Manages CSS and JS file loading for both admin and frontend.
 * Handles asset registration, enqueuing, and localization.
 *
 ...
 * Assets Class
 *
 * Manages all plugin assets including CSS and JavaScript files.
 */
class Assets {
    ...
    private function get_file_version($file_path) {
        $full_path = ARSOL_PFW_PLUGIN_PATH . $file_path;
    ...
    public function register_frontend_assets() {
        $plugin_url = ARSOL_PFW_PLUGIN_URL;
