<?php 
/**
 * Capabilities Class for Arsol Projects for WooCommerce
 *
 ...
 * Capabilities Class
 *
 * Manages WordPress-native capabilities for the plugin.
 */
class Capabilities {
    ...
    public function __construct() {
        ...
        add_action('arsol_pfw_activate', array($this, 'add_administrator_capabilities'));
        add_action('arsol_pfw_deactivate', array($this, 'remove_all_capabilities'));
    }
