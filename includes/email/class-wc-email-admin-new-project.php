...
class WC_Email_Admin_New_Project extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'New Customer Project', 'arsol-projects-for-woo' );
        $this->description    = __( 'Shop manager notification when a new project is created on the frontend.', 'arsol-projects-for-woo' );
    ...
    public function get_default_subject() {
        return __( '[Shop Manager] New Project Created #{project_id}', 'arsol-projects-for-woo' );
    }
    ...
    public function get_default_heading() {
        return __( 'New Project Created', 'arsol-projects-for-woo' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf( __( 'Available placeholders: %s', 'arsol-projects-for-woo' ), '<code>{project_id}, {customer_id}</code>' ),
