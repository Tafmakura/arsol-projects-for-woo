...
class WC_Email_Proposal_Decision extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Project Lead: Proposal Decision', 'arsol-projects-for-woo' );
        $this->description    = __( 'Project lead notification when a proposal decision is made.', 'arsol-projects-for-woo' );
    ...
    public function get_default_subject() {
        return __( '[Project Lead] Proposal {new_status} #{proposal_id}', 'arsol-projects-for-woo' );
    }
    ...
    public function get_default_heading() {
        return __( 'Proposal Status Update', 'arsol-projects-for-woo' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf( __( 'Available placeholders: %s', 'arsol-projects-for-woo' ), '<code>{proposal_id}, {old_status}, {new_status}</code>' ),
