...
class WC_Email_Proposal_Processing extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Project Lead: Proposal Processing', 'arsol-projects-for-woo' );
        $this->description    = __( 'Project lead notification when proposal processing starts.', 'arsol-projects-for-woo' );
        ...
        $this->recipient = __( 'Project Lead', 'arsol-projects-for-woo' );
    }
    ...
    public function get_default_subject() {
        return __( '[Project Lead] Proposal Processing Started #{proposal_id}', 'arsol-projects-for-woo' );
    }
    ...
    public function get_default_heading() {
        return __( 'Proposal Processing Assignment', 'arsol-projects-for-woo' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf( __( 'Available placeholders: %s', 'arsol-projects-for-woo' ), '<code>{proposal_id}, {customer_id}, {project_lead_id}</code>' ),
    ...
    public function get_recipient() {
        ...
        if ( is_admin() && ! wp_doing_ajax() ) {
            return __( 'Project Lead', 'arsol-projects-for-woo' );
        }
