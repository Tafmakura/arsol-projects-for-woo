 ...
 */
class WC_Email_Proposal_Decision_Simple extends WC_Email {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->id             = 'proposal_decision_simple';
        ...
        add_action( 'arsol_pfw_proposal_decision_notification', array( $this, 'trigger' ), 10, 1 );
