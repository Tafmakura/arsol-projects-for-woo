...
class Arsol_Email_Customer_Project_Completion extends WC_Email {

    public function __construct() {
        $this->id             = 'arsol_customer_project_completion';
    ...
    public function get_default_subject() {
        return __('Project Completed: {project_title}', 'arsol-projects-for-woo');
    }

    public function get_default_heading() {
        return __('Your Project Has Been Completed', 'arsol-projects-for-woo');
    }

    public function trigger($project_id, $customer_id = null) {
        $this->setup_locale();
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf(__('Available placeholders: %s', 'arsol-projects-for-woo'), '<code>{project_title}, {project_id}, {customer_name}, {site_title}</code>'),
