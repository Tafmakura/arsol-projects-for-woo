...
class Arsol_Email_Lead_Proposal_Decision extends WC_Email {

    public $decision;

    public function __construct() {
        $this->id             = 'arsol_lead_proposal_decision';
        $this->title          = __('Proposal Decision (Project Lead)', 'arsol-projects-for-woo');
        $this->description    = __('Email sent to project leads when proposal decisions are made.', 'arsol-projects-for-woo');
        $this->template_html  = 'email-proposal-decision.php';
        $this->template_plain = 'plain/email-proposal-decision.php';
    ...
    public function get_default_subject() {
        return __('Proposal Decision: {proposal_title} - {decision}', 'arsol-projects-for-woo');
    }

    public function get_default_heading() {
        return __('Proposal Decision Update', 'arsol-projects-for-woo');
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf(__('Available placeholders: %s', 'arsol-projects-for-woo'), '<code>{proposal_title}, {proposal_id}, {decision}, {lead_name}, {site_title}</code>'),
