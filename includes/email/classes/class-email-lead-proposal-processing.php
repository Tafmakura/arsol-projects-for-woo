...
class Arsol_Email_Lead_Proposal_Processing extends WC_Email {

    public function __construct() {
        $this->id             = 'arsol_lead_proposal_processing';
    ...
    public function get_default_subject() {
        return __('Work Started: {proposal_title}', 'arsol-projects-for-woo');
    }

    public function get_default_heading() {
        return __('Proposal Work Started', 'arsol-projects-for-woo');
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf(__('Available placeholders: %s', 'arsol-projects-for-woo'), '<code>{proposal_title}, {proposal_id}, {lead_name}, {site_title}</code>'),
