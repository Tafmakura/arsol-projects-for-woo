...
class WC_Email_Project_Creation extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Project Customer: Your Project Order Is Ready', 'arsol-projects-for-woo' );
        $this->description    = __( 'Customer notification when their project order is created and ready.', 'arsol-projects-for-woo' );
    ...
    public function get_default_subject() {
        return __( '[{site_title}] Your Project Order is Ready - #{project_id}', 'arsol-projects-for-woo' );
    }
