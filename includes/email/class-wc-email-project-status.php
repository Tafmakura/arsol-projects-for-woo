...
class WC_Email_Project_Status extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Project Customer: Project Status Update', 'arsol-projects-for-woo' );
        $this->description    = __( 'Customer notification when their project status changes.', 'arsol-projects-for-woo' );
