...
class WC_Email_Project_Status extends WC_Email {
    ...
    public function get_default_subject() {
        return __( '[{site_title}] Project Status Update - #{project_id}', 'arsol-pfw' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject'    => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => sprintf( __( 'Available placeholders: %s', 'arsol-pfw' ), '<code>{site_title}, {project_id}, {old_status}, {new_status}</code>' ),
