...
class WC_Email_Lead_Proposal_Processing extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Lead Proposal Processing', 'arsol-pfw' );
        ...
        add_action( 'arsol_lead_proposal_processing_notification', array( $this, 'trigger' ), 10, 1 );
    ...
    public function get_default_subject() {
        return __( 'Lead: Proposal Processing #{proposal_id}', 'arsol-pfw' );
    }
