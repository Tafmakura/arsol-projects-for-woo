...
class Arsol_Email_Manager {
    ...
    public static function add_emails( $email_classes ) {
        ...
        require_once ARSOL_PFW_PLUGIN_DIR . 'includes/email/class-wc-email-proposal-decision-simple.php';

        // Add to email classes
        $email_classes['WC_Email_New_Request'] = new WC_Email_New_Request();
        $email_classes['WC_Email_Proposal_Decision_Simple'] = new WC_Email_Proposal_Decision_Simple();
