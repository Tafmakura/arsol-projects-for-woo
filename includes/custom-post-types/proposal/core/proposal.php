...
class Arsol_PFW_Proposal {
    ...
    public function get_stage() {
        return \Arsol_Projects_For_Woo\Core\Stage_Handler::get_stage($this->proposal_id, self::get_stage_taxonomy());
    }
    ...
    public function set_stage($stage) {
        return \Arsol_Projects_For_Woo\Core\Stage_Handler::set_stage($this->proposal_id, $stage, self::get_stage_taxonomy());
    }
