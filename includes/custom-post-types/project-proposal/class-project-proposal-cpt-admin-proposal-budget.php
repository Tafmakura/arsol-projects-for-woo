...
class Proposal_Budget {
    ...
    public function __construct() {
        ...
        add_filter('default_hidden_meta_boxes', array($this, 'hide_budget_metabox_from_screen_options'), 10, 2);
    }
                        ...
                        <tr class="arsol-line-item arsol-budget-item">
                            <td class="arsol-description-column">
                                <div class="arsol-flex-container">
                                    ...
                                    <input type="text" class="arsol-description-input js-details-input" name="proposal_budget_details" value="<?php echo esc_attr(get_post_meta($post->ID, '_proposal_budget_details', true)); ?>" placeholder="<?php esc_attr_e('Additional details...', 'arsol-pfw'); ?>" disabled>
                                </div>
                            </td>
                            ...
                            <td class="arsol-amount-column">
                                <input type="text" class="arsol-amount-input js-amount-input arsol-budget-amount wc_input_price" name="proposal_budget" value="<?php echo esc_attr($budget_amount); ?>" placeholder="0.00" min="0.01" step="0.01" disabled>
                            </td>
                        ...
                        <tr class="arsol-line-item arsol-budget-item recurring-budget-row">
                            <td class="arsol-description-column">
                                <div class="arsol-flex-container">
                                    ...
                                    <input type="text" class="arsol-description-input js-details-input" name="proposal_recurring_budget_details" value="<?php echo esc_attr(get_post_meta($post->ID, '_proposal_recurring_budget_details', true)); ?>" placeholder="<?php esc_attr_e('Additional details...', 'arsol-pfw'); ?>" disabled>
                                </div>
                            </td>
                            <td class="arsol-date-column">
                                <input type="date" class="arsol-date-input js-date-input start-date-input" name="proposal_recurring_start_date" value="<?php echo esc_attr($recurring_start_date); ?>" disabled>
                            </td>
                            <td class="arsol-amount-column">
                                <input type="text" class="arsol-amount-input js-amount-input arsol-budget-amount recurring-budget-amount-input wc_input_price" name="proposal_recurring_budget" value="<?php echo esc_attr($recurring_budget_amount); ?>" placeholder="0.00" disabled>
                            </td>
                            <td class="arsol-billing-cycle-column">
                                <select name="proposal_billing_interval" class="arsol-billing-select js-billing-input billing-interval" disabled>
                            <?php
                            ...
                            ?>
                                ...
                                <select name="proposal_billing_period" class="arsol-billing-select js-billing-input billing-period" disabled>
                            <?php
    ...
    public function hide_budget_metabox_from_screen_options($hidden, $screen) {
        if ($screen->post_type === 'arsol-pfw-proposal') {
            $hidden[] = 'arsol_budget_estimates_metabox';
        }
        return $hidden;
    }
}
