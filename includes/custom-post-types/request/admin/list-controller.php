...
class List_Controller {
    ...
    public function render_custom_column($column, $post_id) {
        switch ($column) {
            ...
            case 'customer':
                ...
                break;
            case 'request_budget':
                $this->render_budget_column_direct($post_id);
                break;
        }
    }
    ...
    private function render_stage_column_direct($post_id) {
        $terms = wp_get_object_terms($post_id, 'arsol-pfw-request-stage', ['fields' => 'all']);
    ...
    /**
     * Render budget column using direct WordPress functions
     */
    private function render_budget_column_direct($post_id) {
