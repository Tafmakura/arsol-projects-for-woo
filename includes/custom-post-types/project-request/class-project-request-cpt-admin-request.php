        ...
        <ul class="order_actions submitbox">
            <li class="wide">
                <div id="delete-action">
                    ...
                    $convert_url = admin_url('admin-post.php?action=arsol_convert_request_to_proposal&request_id=' . $post->ID);
                    $convert_url = wp_nonce_url($convert_url, 'arsol_convert_request_to_proposal_nonce');
                    $confirm_message = esc_js(__('Are you sure you want to convert this request to a proposal? This will create a new proposal with selected items.', 'arsol-pfw'));
