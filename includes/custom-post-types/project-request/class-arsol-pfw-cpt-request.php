    ...
    public function convert_to_proposal() {
        ...
        $proposal_data = array(
            ...
            'meta_input' => array(
                ...
                '_arsol_pfw_proposed_project_start_date' => $this->get_meta('_arsol_pfw_requested_project_start_date'),
                '_arsol_pfw_proposed_project_due_date' => $this->get_meta('_arsol_pfw_requested_project_due_date')
            )
        );
