...
class List_Controller {
    ...
    private function render_customer_column_direct($post_id) {
        ...
        if ($customer_id) {
            echo arsol_pfw_format_user($customer_id, 'filter_link', ['post_type' => 'arsol-pfw-project']);
        } else {
    ...
    private function render_project_lead_column_direct($post_id) {
        ...
        if ($lead_id) {
            echo arsol_pfw_format_user($lead_id, 'filter_link', ['post_type' => 'arsol-pfw-project']);
        } else {
            echo '<span class="na">&ndash;</span>';
        }
    }
