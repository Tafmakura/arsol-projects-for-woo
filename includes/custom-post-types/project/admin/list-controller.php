...
class List_Controller {
    ...
    private function render_customer_column_direct($post_id) {
        ...
        if ($customer_id) {
            echo \Arsol_Projects_For_Woo\Functions\format_user_display($customer_id, 'filter_link', ['post_type' => 'arsol-pfw-project']);
        } else {
    ...
    private function render_project_lead_column_direct($post_id) {
        ...
        if ($lead_id) {
            echo \Arsol_Projects_For_Woo\Functions\format_user_display($lead_id, 'filter_link', ['post_type' => 'arsol-pfw-project']);
        } else {
            echo '<span class="na">&ndash;</span>';
        }
    }
