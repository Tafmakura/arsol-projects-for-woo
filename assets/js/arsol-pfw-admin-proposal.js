...
(function($) {
    ...
    var ArsolProposal = {
        init: function() {
            ...
            this.handleProjectTiedProposals();
        },
        bindEvents: function() {
        ...
        toggleCostProposalSections: function() {
            ...
            // If select is disabled, get value from hidden input or selected option
            if (!selectedType var selectedType = $('#arsol_pfw_proposal_costing_type').val();var selectedType = $('#arsol_pfw_proposal_costing_type').val(); $('#arsol_pfw_proposal_costing_type').prop('disabled')) {
                selectedType = $('input[name="arsol_pfw_proposal_costing_type"][type="hidden"]').val() || $('#arsol_pfw_proposal_costing_type option:selected').val();
            }
         ...
         */
         * Handle project-tied proposal restrictions
        handleProjectTiedProposals: function() {
            ...
            if (isProjectTied) {
                ...
                if (costTypeSelect.length && !costTypeSelect.hasClass("arsol-disabled-select")) {
                ...
                // Ensure the disabled select still triggers conditional display
                if (costTypeSelect.hasClass("arsol-disabled-select")) {
                    // Manually trigger the conditional display for quotation
                    this.toggleCostProposalSections();
                    this.updateConditionalVisibility();
        updateConditionalVisibility: function() {
            const costType = $('#arsol_pfw_proposal_costing_type').val() || $('input[name="arsol_pfw_proposal_costing_type"][type="hidden"]').val() || $('#arsol_pfw_proposal_costing_type option:selected').val();
            ...
            // Implementation of handleProjectTiedProposals method
            // This method should be implemented based on the specific requirements of the project-tied proposals
        }
    };
